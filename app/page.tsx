      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-10 gap-6 lg:gap-8 animate-fade-in">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <Link href={`/${art1.category}/${art1.slug}`} className="group block">
            ...
            <p className="text-[13px] leading-[1.4] mb-4 font-medium text-[#3A4B5C]">
              The combination of my father's death and my personal background lit a fire in me to know more.
            </p>
            <p className="text-[13px] leading-[1.4] mb-5 font-medium text-[#3A4B5C]">
          ...
          <Link href={`/${art2.category}/${art2.slug}`} className="group block">
            <h3 className="text-xl font-serif font-bold leading-tight mb-4 group-hover:underline decoration-1 underline-offset-2 transition-all line-clamp-2">
              The Founder's Guide to Actually Understanding Users Nowadays.
            </h3>
            <p className="text-[11px] leading-[1.4] font-medium text-[#3A4B5C] line-clamp-3">
        ...
        <div className="lg:col-span-4 flex flex-col gap-5">
          <Link href={`/${artCenter.category}/${artCenter.slug}`} className="group block">
            ...
            <h3 className="text-[1.7rem] font-serif font-bold leading-[1.15] mb-4 group-hover:underline decoration-1 underline-offset-2 transition-all line-clamp-2">
              How 7 Lines of Code Turned Into a $36 Billion Empire.
            </h3>
            <p className="text-[13px] leading-[1.4] font-medium text-[#3A4B5C] mb-5 line-clamp-3">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <Link href={`/${artCol3_1.category}/${artCol3_1.slug}`} className="group block">
            ...
            <h3 className="text-[1.1rem] font-serif font-bold leading-tight mb-2 group-hover:underline decoration-1 underline-offset-2 transition-all line-clamp-2">
              To Become <span className="highlight-blue">Happier</span>, Ask Yourself These Two Questions Every Night
            </h3>
            <p className="text-[11px] leading-[1.4] font-medium line-clamp-3">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <Link href={`/${artCol4_1.category}/${artCol4_1.slug}`} className="group block">
            <h3 className="text-xl font-serif font-bold leading-tight mb-3 group-hover:underline decoration-1 underline-offset-2 transition-all line-clamp-2">
              Traveller Visiting Ice Cave With Amazing Eye-catching Scenes
            </h3>
            <p className="text-[11px] leading-[1.4] font-medium text-[#3A4B5C] mb-4 line-clamp-3">
          ...
          <Link href={`/${art2.category}/${art2.slug}`} className="group block pt-2">
            <h4 className="text-[1.2rem] font-serif font-bold leading-tight mb-3 group-hover:underline decoration-1 underline-offset-2 transition-all line-clamp-2">
              Essential Habits & Routine Changes That Can Enrich <span className="highlight-yellow">Your Life</span>
            </h4>
            <p className="text-[12px] leading-[1.4] font-medium text-[#3A4B5C] mb-4 line-clamp-3">
